...
const ToDoList = () => {
  ...
  const { addNote, getNotes, deleteNote, editNote } = context;
  ...
  const handleUpdateTask = async () => {
    try {
      setLoading(true);
      const response = await editNote(currentEditItem?._id, updatedTitle, updatedDescription, updatedStatus)
  ...
  return (
    <>
      ...
      <section className={styles.toDoWrapper}>
                  ...
                  <div className={styles.toDoCardFooter}>
                    ...
                    <div className={styles.toDoFooterAction}>
                      ...
                      {item?.isCompleted ? (
                        <Tooltip title="Mark as Incomplete">
                          <CheckCircleFilled
                            onClick={() => handleUpdateStatus(item._id,item.title, item.description, false)}
                            style={{ color: "green" }}
                            className={styles.actionIcon}
                          />
                        </Tooltip>
                        ...
                        <Tooltip title="Mark as Completed">
                          <CheckCircleOutlined
                            onClick={() => handleUpdateStatus(item._id,item.title, item.description, true)}
                            className={styles.actionIcon}
                          />
                        </Tooltip>
                      )}
        ...
        <Modal confirmLoading={loading} title="Add New To Do Task" open={isAdding} onOk={!title || !description ? undefined: handleSubmitTask}  onCancel={() => setIsAdding(false)}>
